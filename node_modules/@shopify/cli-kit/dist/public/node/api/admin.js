...
const LatestApiVersionByFQDN = new Map();
/**
...
export async function adminRequestDoc(options) {
    ...
    if ('refresh' in session) {
        unauthorizedHandler = { type: 'token_refresh', handler: session.refresh };
    }
 ...
 */
export function adminUrl(store, version, session) {
    const realVersion = version ?? 'unstable';
    const url = session && isThemeAccessSession(session)
